<?php
/*
 * File Name:GroupOutletSumDownloadData.class.php
 * Author:zhangliming
 * mail:zhangliming@ganji.com
 */
set_time_limit(3600);
class Service_Data_HouseReport_GroupOutletSumDownloadData extends Service_Data_HouseReport_GroupOutletData
{
