 ...
 */
class Service_Data_Apartment_Photo
{
     ...
     * @return array 
     */
    public function getApartmentPhotoByApartmentId($apartmentId, $arrFields=array(), $status=1)
    {
        try {
            ...
            $daoModel = Gj_LayerProxy::getProxy('Dao_Fangproject_ApartmentPhoto');
