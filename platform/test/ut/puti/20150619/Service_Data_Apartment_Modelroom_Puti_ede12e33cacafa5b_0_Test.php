<?php
            ...
            class Service_Data_Apartment_Modelroom_Puti_ede12e33cacafa5b_Test extends Testcase_PTest
            {
  ...
  array (
    'city_domain' => 'bj',
        ...
        $fakeObj_0->expects($this->any())->method("getModelroomByParams")->will($this->returnValue(array()));
           ...
           $fakeObj_same = $this->genObjectMock("Service_Data_Apartment_Modelroom", array("getModel","serializeParams"), array(), "", 0);
           $fakeObj_same->expects($this->any())->method("getModel")->will($this->returnValue($fakeObj_0));

           $fakeObj_same->expects($this->any())->method("serializeParams")->will($this->returnValue($fakeObj_0));
