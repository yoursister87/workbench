 ...
 */
class GetDelCommentHouseList extends Testcase_PTest
{
	protected $data;
	...
	public function testExecute(){
		...
		$obj = $this->genObjectMock("Service_Data_Source_HouseRealQuery",array("getDelCommentHouseList"));
		$obj->expects($this->any())
		->method("getDelCommentHouseList")
		->with($arrInput)
		->will($this->returnValue($this->data));
		Gj_LayerProxy::registerProxy("Service_Data_Source_HouseRealQuery", $obj);
		$spam = new Service_Page_RealHouse_GetDelCommentHouseList();
		...
		$spamObj = new Service_Page_RealHouse_GetDelCommentHouseList();
