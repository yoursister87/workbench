 ...
 */
class GetCommentHouseList extends Testcase_PTest
{
	protected $data;
	...
	public function testExecute(){
		...
		$obj = $this->genObjectMock("Service_Data_Source_HouseRealQuery",array("getCommentHouseList"));
		$obj->expects($this->any())
		->method("getCommentHouseList")
		->with($arrInput)
		->will($this->returnValue($this->data));
		Gj_LayerProxy::registerProxy("Service_Data_Source_HouseRealQuery", $obj);
		$spam = new Service_Page_RealHouse_GetCommentHouseList();
		...
		$spamObj = new Service_Page_RealHouse_GetCommentHouseList();
