<?php
class GroupOutletSumDownloadDataTest  extends Testcase_PTest{
   ...
   /**   
    ...
    public function testgroupDownLoadDataException(){
        ...
        $params = array();
        $res =false;
        $obj1 = new Service_Data_HouseReport_GroupOutletSumDownloadData();
   ...
   public function testgroupDownLoadData(){
        ...
        $obj1 = $this->genObjectMock("Service_Data_HouseReport_GroupOutletSumDownloadData",array("getPremierData","getAssureData","getBidData","getReportDate","getFrameAuditingData","getAccountData","getSortCategory","formartData","getCrmAccountEmail","getUserCenterBalance","getBidBalance"));
