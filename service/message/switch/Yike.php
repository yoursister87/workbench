...
class Hk_Service_Message_Switch_Yike extends Hk_Service_Message_Switch_Base
{
    const YIKE_SWITCH_IMCHAT    = "liveIMChatMsg";

    // 一课app目前支持的开关配置
    public static $SwitchSet    = array(
        self::YIKE_SWITCH_IMCHAT,
    );

    // Message对应的控制开关
    public static $CmdSwitchMap = array(
        Hk_Service_Message_Const::APP_IM_PUSH_CUIDS => self::YIKE_SWITCH_IMCHAT,
        Hk_Service_Message_Const::APP_IM_PUSH_UIDS  => self::YIKE_SWITCH_IMCHAT,
    );
     ...
     * 用户开关信息存储的键名
     */
    public $key = "YIKE_USER_SWITCH_INFO";
